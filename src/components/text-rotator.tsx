...
export default function TextRotator(): React.JSX.Element {
  return (
    <div className="py-4  rounded-md flex flex-col justify-center items-center overflow-hidden">
      <div className="font-poppins text-base sm:text-2xl [text-wrap:balance] text-gray-700">
        ...
        <span className="inline-flex ml-2 flex-col h-[calc(var(--text-lg)*(var(--leading-tight)))] sm:h-[calc(var(--text-3xl)*(var(--leading-tight)))] overflow-hidden">
